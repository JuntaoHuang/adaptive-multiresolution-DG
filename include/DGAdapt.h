...
public:
	...
	virtual void init_separable_scalar(std::function<double(double, int)> scalar_func) override;
	...
	virtual void init_separable_scalar_sum(std::vector<std::function<double(double, int)>> sum_scalar_func) override;	
	void init_separable_system_sum(std::vector<std::vector<std::function<double(double, int)>>> sum_vector_func);
	//void init_separable_system_sum(std::vector<std::vector<std::function<double(double, int)>>> sum_vector_func, const std::vector<int> & var_ind);

	// adaptive initialization for a function of non-separable form f=f(x1,x2,...,xdim)
	// ******************************* TO BE COMPLETED *******************************
	virtual void init_no_separable_scalar(std::function<double(std::vector<double>)> func) override {};
	virtual void init_no_separable_system(std::vector<std::function<double(std::vector<double>)>> vector_func) override {};
